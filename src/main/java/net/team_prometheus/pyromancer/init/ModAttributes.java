...
public class ModAttributes {
    ...
    public static final RegistryObject<Attribute> FLAME_DAMAGE = ATTRIBUTES.register("generic.flame_damage", () -> new RangedAttribute("attribute.name.generic.flame_damage", 0f, 0f, 666f));
    public static final RegistryObject<Attribute> SOULFLAME_DAMAGE = ATTRIBUTES.register("generic.soulflame_damage", () -> new RangedAttribute("attribute.name.generic.soulflame_damage", 0f, 0f, 666f));
    public static final RegistryObject<Attribute> HELLBLAZE_DAMAGE = ATTRIBUTES.register("generic.hellblaze_damage", () -> new RangedAttribute("attribute.name.generic.hellblaze_damage", 0f, 0f, 666f));
}
