package net.team_prometheus.pyromancer.entity.models;// Made with Blockbench 4.7.2
...
import net.team_prometheus.pyromancer.entity.unburned.UnburnedAnimations;
