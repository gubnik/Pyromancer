...
public class NapalmBombsack extends ThrowableItemProjectile {
    ...
    protected @NotNull Item getDefaultItem() {
        return ModItems.NAPALM_BOMBSACK.get();
    }
    ...
    public static void collisionEffect(NapalmBombsack bombsack, Level level){
        level.explode(bombsack, ModDamageSource.BOMBSACK, null, bombsack.getX(), bombsack.getY(), bombsack.getZ(), 1.5f, true, Explosion.BlockInteraction.NONE);
    }
}
